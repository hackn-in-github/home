...
# (*'-')/ \U0028\U002A\U0027\U002D\U0027\U0029\U002F
# (*'~')? \U0028\U002A\U0027\U007E\U0027\U0029\U003F
#  $(if [ $? != 0 ]; then echo -e "\U0028\U002A\U0027\U002D\U0027\U0029\U002F"; else echo -e "\U0028\U002A\U0027\U007E\U0027\U0029\U003F"; fi) 
# PS1='\[\e[34;1m\]\D{%c %Z %%%%%EY%%%%} [ \[\e[m\]\[\e[32;1m\]\w\[\e[m\] \[\e[34;1m\]]\[\e[m\]\n\[\e[32;1m\]\u \[\e[m\]\[\e[$(if [ $? != 0 ]; then echo "31"; else echo "36"; fi);1m\] \$ \[\e[m\]'
PS1='\[\e[34;1m\]\D{%c %Z %%%%%EY%%%%} [ \[\e[m\]\[\e[32;1m\]\w\[\e[m\] \[\e[34;1m\]]\[\e[m\]\n\[\e[32;1m\]\u \[\e[m\]$(if [ $? != 0 ]; then echo "\[\e[31;1m\]"; else echo "\[\e[36;1m\]"; fi)\$ \[\e[m\]'
